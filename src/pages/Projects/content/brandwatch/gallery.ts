export default [
  ...
  {
    src: "/projects/brandwatch/gallery/dci.png",
    alt: "Digital consumer intelligence page",
  },
  {
    src: "/projects/brandwatch/gallery/cr.png",
    alt: "Brandwatch Consumer Research product page",
  },
  {
    src: "/projects/brandwatch/gallery/cpg.png",
    alt: "Example page builder page (CPG)",
  },
  {
  ...
  {
    src: "/projects/brandwatch/gallery/careers.png",
    alt: "Careers page hero",
  },
  {
    src: "/projects/brandwatch/gallery/smc-mob.png",
    alt: "An interactive survey tool results page built with the design system (mobile)",
  },
  {
    src: "/projects/brandwatch/gallery/smc-desktop.png",
    alt: "An interactive survey tool results page built with the design system (desktop)",
  },
  {
