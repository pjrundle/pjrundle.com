...
export const projectsManifest: TProjectManifestEntry[] = [
  ...
  },
  {
    ...
    categoryLabel: "Startup / SaaS",
    detailPageDescription:
      "Embedded across product discovery, prototyping, and front-end delivery.",
    detailPageHeading: "Product design and front-end architecture",
    ...
    logoAdjust: 0.91,
    name: "Cloud.IQ",
    projectCardHeading: "Product design + front-end architecture",
  ...
  },
  {
    ...
    detailPageDescription:
      "Design and content systems powering Brandwatch’s global marketing platform.",
    detailPageHeading: "Design system and marketing platform",
    ...
    logoAdjust: 1.1,
    name: "Brandwatch",
    projectCardHeading: "Design system and marketing platform",
    projectCardImgSrc: "/projects/brandwatch/hero/hero-2.png",
    role: "Web Team Lead | Senior Front-End Designer/Developer",
    scope: "Design system, content builder tooling, front-end architecture",
    slug: "brandwatch",
    stats: [
