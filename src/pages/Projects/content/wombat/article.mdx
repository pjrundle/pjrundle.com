...
**Most CMS platforms trade off flexibility against consistency. Visual builders allow freedom, but often lead to inconsistent layouts and off-brand output.**

**More structured systems enforce consistency, but are rigid and difficult to evolve as designs change.**

---

## Approach

Wombat takes a structured approach to content creation, built around a design system.

Pages are composed from predefined, reusable blocks, each aligned with a shared set of tokens.

This allows teams to move quickly while maintaining consistency, ensuring output remains on-brand without requiring constant designer or developer input.

The result is a CMS that balances flexibility with control, enabling scalable content production without sacrificing quality.

<ArticleImage
  src="/projects/wmbt/gallery/every-theme-has-a-style-guide.png"
  caption="An example auto-generated shareable style guide"
/>
...
<ArticleImage src="/projects/wmbt/gallery/editable-inline-text.png" />
<ArticleImage src="/projects/wmbt/gallery/floating-ui-controls.png" />
...
## Product Direction & Core Insight
...
- Export to Figma - improve and iterate

<ArticleImage
  src="/projects/wmbt/gallery/export-theme-to-figma.png"
  caption="Themes can be exported to Figma"
/>

We aim to launch Wombat's own marketing site as the first fully featured site built with Wombat – using it to stress test all features across CMS, theming, custom blocks etc.
