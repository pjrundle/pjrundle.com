...
At Brandwatch, the web platform operated across 5–10 active websites at any time, each containing thousands of pieces of content produced by marketers, legal teams, and product teams – all of which had to adhere to strict brand guidelines.

This was enabled by and underlying design system and component library, paired with multiple specialized "builder" systems tailored to produce different content types:
...
Design direction was led by the design team (CDO, art director, web designers - including myself). Marketers and internal teams used the structured builder systems to produce high‑volume, on‑brand content at speed.
...
What does editing a website look like in 2026?

For many structured/editorial CMS platforms, editing still means form‑based control panels disconnected from the rendered page. While functional, this does create cognitive distance between configuration and output.
...
Extracting it into ThemeOS formalized what had previously been internal infrastructure.
